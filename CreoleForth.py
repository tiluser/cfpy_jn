...
class CorePrims:
    ...
    def doTulip(self, gsp):
        ...
        # alert(text="Tulip", title='Creole Forth', button='OK')
        print("Tulip")
...
cfb1.buildPrimitive("EVAL", cfb1.Modules.CorePrims.doEval, "CorePrims.doEval", "FORTH", "COMPINPF","( code -- ) Evaluates raw Python code")
